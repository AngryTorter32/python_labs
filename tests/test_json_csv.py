...
def test_json_to_csv_roundtrip(tmp_path: Path):
    """Тест конвертации JSON в CSV с последующей проверкой содержимого."""
...
def test_csv_to_json_roundtrip(tmp_path: Path):
    """Тест конвертации CSV в JSON с последующей проверкой содержимого."""
...
def test_json_to_csv_file_not_found(tmp_path: Path, capsys):
    """Тест обработки отсутствующего файла JSON."""
